...
<template>
  <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 shadow-xs shrink-0 relative z-50">
    ...
    <div class="flex items-center gap-4">
      ...
      <button
        type="button"
        class="inline-flex items-center gap-2 border border-gray-200 rounded px-4 py-2 hover:bg-gray-50 text-gray-700 text-sm font-semibold hover:border-gray-300 transition cursor-pointer"
        @click="openSignOut"
      >
        Sign out
      </button>
