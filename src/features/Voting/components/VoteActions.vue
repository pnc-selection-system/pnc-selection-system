...
<template>
  <div class="flex flex-wrap items-end gap-4 border-t border-slate-100 px-6 py-5">
    ...
    <div class="min-w-[240px] flex-1">
      ...
      <input
        type="text"
        class="mt-1.5 w-full rounded-md border border-slate-200 px-3 py-2 text-sm text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-100 disabled:bg-slate-50"
