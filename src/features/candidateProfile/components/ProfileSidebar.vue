...
function getBadgeType(status: CandidateStatus): 'success' | 'warning' | 'info' | 'danger' | 'primary' {
  switch (status) {
    case 'approved':
...
<template>
  <div class="w-[280px] flex-shrink-0 rounded border border-slate-200 bg-white p-6">
    <!-- Photo -->
    <div class="flex justify-center mb-4">
      ...
      >
        ...
        <!-- Hover overlay -->
        <div class="absolute inset-0 grid place-items-center bg-black/40 opacity-0 transition-opacity group-hover:opacity-100">
    ...
    <!-- Status Badge -->
    <div class="text-center">
      <BaseBadge :type="getBadgeType(candidate.status)" size="default">
