  ...
  <div class="rounded-lg border border-dashed border-slate-200 px-4 py-3.5 hover:border-slate-300">
    <div class="flex items-center justify-between gap-4">
      ...
      <div class="flex shrink-0 items-center gap-2">
        ...
        <BaseButton variant="danger" size="small" @click="emit('remove')">
    ...
    <div v-if="question.type === 'scale_1_5'" class="mt-3 flex items-center justify-start gap-2">
      <button
        v-for="n in 5"
        :key="n"
        type="button"
    ...
    <div v-else-if="question.type === 'single_choice' || question.type === 'multi_choice'" class="mt-3 flex flex-wrap items-center justify-start gap-2">
      <button
